  ...
  return (
    <div className={`rounded-xl overflow-hidden shadow-[rgba(7,_65,_210,_0.1)_0px_9px_30px] ${className}`}>
        ...
        <div className='p-5'>
            ...
            <p className='mt-3 text-sm text-dark-light md:text-lg'>Majority of people will work in jobs that don't exist today.</p>
                ...
                <div className='flex items-center gap-x-2 md:gap-x-2.5'>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <div className='flex items-center gap-x-2'>
                            <span className='bg-[#36B37E] w-fit bg-opacity-20 p-1.5 rounded-full'><BsCheckLg className='w-1.5 h-1.5 text-[#36B37E] text-xl' /></span>
